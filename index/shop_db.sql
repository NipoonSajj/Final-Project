...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=137103475ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop_db&table=products">`shop_db`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop_db&table=cart">`shop_db`.`cart`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop_db&table=user_form">`shop_db`.`user_form`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blob&table=images">`blob`.`images`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test_db&table=images">`test_db`.`images`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gallery&table=gallery">`gallery`.`gallery`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop_db&table=products1">`shop_db`.`products1`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop_db&table=products2">`shop_db`.`products2`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop_db&table=images">`shop_db`.`images`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop_db&table=image">`shop_db`.`image`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6f5b5d4241563e4469366b66673d3f72">
